                                ...
                                <CardContent>
                                    ...
                                    {new Date(phase.date).toLocaleDateString("en-US", {
                                        ...
                                        year: "numeric",
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    <Clock
                                                                        className={`h-4 w-4 ${isPastDeadline ? "text-muted-foreground" : "text-accent"}`}
                                                                    />
                                                                    <span className="text-muted-foreground">Deadline:</span>
                                                                    <span
                                                                        className={isPastDeadline ? "text-muted-foreground" : "text-accent font-semibold"}
                                                                    >
